...
It also uses a simplified version of a global timezone map from https://github.com/evansiroky/timezone-boundary-builder, which is released under the [Open Data Commons Open Database License (ODbL)](https://opendatacommons.org/licenses/odbl/).
